...
-- Telegram 
function Tab:AddTelegramInvite(Configs)
      local TelegramLink = Configs[1] or Configs.TelegramLink or "https://t.me/"
      local TelegramIcon = Configs[2] or Configs.TelegramIcon or "rbxassetid://"
      local TelegramTitle = Configs[3] or Configs.TelegramTitle or ""
      ...
      local TelegramInvite = {}
      
      function TelegramInvite:Set(NewVal)
        if typeof(NewVal) == "string" then
          if string.find(NewVal, "https://t.me/") then LinkLabel.Text = NewVal
          elseif string.find(NewVal, "rbxassetid://") then IconLabel.Image = NewVal
          else TitleLabel.Text = NewVal end
        end
      end
      function TelegramInvite:Visible(Bool)Frame1.Visible = Bool end
      function TelegramInvite:Destroy()Frame1:Destroy()end
